      ...
      <div className="hidden lg:flex flex-col justify-between w-[42%] bg-[hsl(var(--bg-surface))] border-r border-[hsl(var(--border-subtle))] p-10">
        ...
        <div>
          <h2 className="text-3xl font-bold text-[hsl(var(--text-primary))] leading-tight mb-4">
            Your autonomous<br />financial intelligence<br />platform
          </h2>
          <div className="space-y-3">
            {[
              "Gmail → n8n → GPT-4o extraction, zero manual data entry",
              "Organization-level multi-tenancy with role-based access",
              "AI CFO insights, forecasting & anomaly detection",
            ].map((f) => (
              <div key={f} className="flex items-start gap-2.5 text-sm text-[hsl(var(--text-secondary))]">
                <div className="w-1.5 h-1.5 rounded-full bg-[hsl(var(--accent))] mt-1.5 flex-shrink-0" />
                {f}
              </div>
            ))}
          </div>
        ...
        <p className="text-xs text-[hsl(var(--text-muted))]">
          &copy; {new Date().getFullYear()} Finvora AI. Enterprise Financial Intelligence.
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex justify-between items-center p-5">
          ...
          <div className="ml-auto flex items-center gap-3">
            <ThemeToggle />
            <Link href="/signup" className="text-sm text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] transition-colors">
              Create account
            </Link>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-sm">
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-[hsl(var(--text-primary))] mb-1">Welcome back</h1>
              <p className="text-sm text-[hsl(var(--text-muted))]">Sign in to your account</p>
            </div>
            ...
            <p className="text-center text-xs text-[hsl(var(--text-muted))] mt-6">
              No account?{" "}
              <Link href="/signup" className="text-[hsl(var(--accent))] hover:underline">
                Sign up for free
              </Link>
            </p>
          </div>
